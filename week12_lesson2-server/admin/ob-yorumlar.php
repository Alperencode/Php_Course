                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
										...
										$sorgu = "SELECT yorumlar.*, kullanicilar.id AS kid, kullanicilar.ad, kullanicilar.soyad FROM yorumlar INNER JOIN kullanicilar ON yorumlar.kid = kullanicilar.id WHERE onay=0 ORDER BY id DESC";
