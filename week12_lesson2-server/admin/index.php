        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
					...
					<li>
                        <a <?php if(@$_GET["sayfa"]=="ob-yorumlar") echo 'class="active-menu"'; ?> href="?sayfa=ob-yorumlar"><i class="fa fa-edit"></i>Onay Bekleyen Yorumlar</a>
                    </li>
					
					<li>
                        <a <?php if(@$_GET["sayfa"]=="yorumlar") echo 'class="active-menu"'; ?> href="?sayfa=yorumlar"><i class="fa fa-edit"></i>Onaylı Yorumlar</a>
                    </li>
					
					<li>
                        <a <?php if(@$_GET["sayfa"]=="hakkimizda") echo 'class="active-menu"'; ?> href="?sayfa=hakkimizda"><i class="fa fa-edit"></i>Hakkımızda</a>
                    </li>
