	...
	<header style="position: sticky">
		...
		<div class="container">
			...
			<ul class="main-menu" id="main-menu">
				...
				<li><a href="index.php?sayfa=haberler&kategori=bilim">BİLİM</a></li>
				<li><a href="index.php?sayfa=haberler&kategori=teknoloji">TEKNOLOJİ</a></li>
				<li><a href="index.php?sayfa=haberler&kategori=spor">SPOR</a></li>
				<li><a href="index.php?sayfa=haberler&kategori=sanat">SANAT</a></li>
				<li><a href="index.php?sayfa=haberler&kategori=saglik">SAĞLIK</a></li>
				<li class="drop-down"><a href="#">KULLANICI PANELİ<i class="ion-arrow-down-b"></i></a>
					<ul class="drop-down-menu drop-down-inner">
						<li><a href="index.php?sayfa=uyeOl">ÜYE OL</a></li>
						<li><a href="index.php?sayfa=oturumAc">OTURUM AÇ</a></li>
					</ul>
				</li>
			</ul>
