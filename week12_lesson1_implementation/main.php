...
rsort($idler);
	  ...
	  for($i=0; $i<5; $i++){
		  ...
		  echo '<a class="carousel-image" href="?sayfa=haber&hid='.$satir["id"].'"><img style="height:100%"  src="manset/'.$satir["resim"].'" alt=""></a>
					<div class="carousel-caption d-none d-md-block">
						<h3 style="padding:5px; background-color: rgba(52, 52, 52, .5);text-shadow: 2px 2px 2px black">'.$satir["baslik"].'</h3>
					</div>
				</div>';
    ...
    <span class="sr-only">Next</span>
				...
				?>
					<div class="pl-5 pb-5 pl-sm-0 ptb-sm-5 pos-relative h-50">
						<a class="pos-relative h-100 dplay-block" href="?sayfa=haber&hid=<?php echo $satir["id"] ?>">
			...
			<div class="row">
				...
				<div class="col-md-12 col-lg-8">
					...
					<?php
						...
						$satir = mysqli_fetch_array($sec);
					?>
						<a href="?sayfa=haber&hid=<?php echo $satir["id"] ?>">
						<div class="col-sm-6">
							<img src="manset/<?php echo $satir["resim"] ?>" alt="">
							<h4 class="pt-20"><a href="?sayfa=haber&hid=<?php echo $satir["id"] ?>"><b><?php echo $satir["baslik"] ?></b></a></h4>
							<ul class="list-li-mr-20 pt-10 pb-20">
								<li class="color-lite-black"><?php echo tarihYaz($satir["zaman"]) ?></li>
							...
							<?php
								...
								<div class="ml-120 min-h-100x">
									...
									<ul class="list-li-mr-20 pt-0">
										<li class="color-lite-black pt-10">'.tarihYaz($satir["zaman"]).'</li>
				...
				<div class="col-md-6 col-lg-4">
					<div class="pl-20 pl-md-0">
						...
						<div class="mt-0 mb-50">
							...
							<?php
							$sorgu = "SELECT * FROM haberler ORDER BY okunmaSayisi DESC LIMIT 5";
							$sec = mysqli_query($baglanti,$sorgu);
							...
							while($satir = mysqli_fetch_array($sec)){
								...
								$baslik = $satir['baslik'];
								$resim = $satir['resim'];
								$okunmaSayisi = $satir['okunmaSayisi'];
								$kategori = $satir['kategori'];
								$yorumSayisi = $satir['yorumSayisi'];

								echo '<a class="oflow-hidden pos-relative mb-20 dplay-block" href="?sayfa=haber&hid='.$satir['id'].'">
											<div class="wh-100x abs-tlr"><img src="manset/'.$resim.'" alt=""></div>
											<div class="ml-120 min-h-100x">
												<h5><b>'.$baslik.'</b></h5>
						...
						<div class="mt-0 mb-50">
							...
							<?php
							$sorgu = "SELECT * FROM haberler ORDER BY yorumSayisi DESC LIMIT 5";
							$sec = mysqli_query($baglanti,$sorgu);
					...
					<div class="mt-0 mb-50">
						<h4 class="p-title"><b>EN POPÜLER HABERLER</b></h4>
						<?php
