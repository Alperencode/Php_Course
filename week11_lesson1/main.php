  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
     	<img src="images/slider1.jpg" style="height: 100%; object-fit: cover;" alt="First slide">
		<div class="carousel-caption d-none d-md-block">
    		<h5>Açıklama 1</h5>
  		</div>
    </div>
    <div class="carousel-item">
      <img src="images/slider2.jpg" style="height: 100%; object-fit: cover;" alt="Second slide">
		<div class="carousel-caption d-none d-md-block">
    		<h5>Açıklama 2</h5>
  		</div>
    </div>
    <div class="carousel-item" style="background: url("images/")">
      <img src="images/slider3.jpg" style="height: 100%; object-fit: cover;" alt="Third slide">
		<div class="carousel-caption d-none d-md-block">
    		<h5>Açıklama 3</h5>
  		</div>
    </div>
  ...
  <a class="carousel-control-next" href="#carouselExampleIndicators" role="button" data-slide="next">
    ...
    <span class="sr-only">Next</span>
				...
				<?php
					$sorgu = "SELECT * FROM haberler WHERE kategori = 'Teknoloji'  ORDER BY id DESC LIMIT 1";	
...
<li><?php echo date('d M Y', strtotime($satir["zaman"])) ?></li>
					...
					<?php
					$sorgu = "SELECT * FROM haberler WHERE kategori = 'Sanat' ORDER BY id DESC LIMIT 1";	
					$sec = mysqli_query($baglanti, $sorgu);
					$satir = mysqli_fetch_array($sec);
					?>
			...
			<div class="h-1-3 oflow-hidden">
					<?php
					$sorgu = "SELECT * FROM haberler WHERE kategori = 'Bilim' ORDER BY id DESC LIMIT 1";	
					$sec = mysqli_query($baglanti, $sorgu);
					$satir = mysqli_fetch_array($sec);
					?>
				...
				<?php
					$sorgu = "SELECT * FROM haberler WHERE kategori = 'Sağlık' ORDER BY id DESC LIMIT 1";	
					$sec = mysqli_query($baglanti, $sorgu);
					$satir = mysqli_fetch_array($sec);
					?>
				...
				<?php
					$sorgu = "SELECT * FROM haberler WHERE kategori = 'Spor' ORDER BY id DESC LIMIT 1";	
					$sec = mysqli_query($baglanti, $sorgu);
					$satir = mysqli_fetch_array($sec);
					?>
			...
			<div class="row">
				...
				<div class="col-md-12 col-lg-8">
					...
					?>
						...
						<div class="col-sm-6">
							<?php
								$sorgu = "SELECT * FROM haberler WHERE kategori =  'Bilim' ORDER BY id DESC LIMIT 1, 4";
								$sec = mysqli_query($baglanti, $sorgu);
